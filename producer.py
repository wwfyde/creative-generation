...
def main():
    ...
    channel.queue_declare(
        queue=settings.texture_generation_queue, durable=True
    )  # 声明队列
    ...
    while True:
        ...
        message = {
            ...
            "data": {
                ...
                "prompt": "",
                "config": {"batch_size": 4},
                "substitution": {"subject": "樱花, 日式, 山海纹, 富士山"},
                "parameter": {"aspect": "4:3", "tile": True},
                "tags": [""],
            },
        }
        ...
        print(
            f"[x] sent to {settings.texture_generation_queue} with message {message_str}"
        )
